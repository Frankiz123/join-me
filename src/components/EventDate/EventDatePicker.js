...
const EventDatePicker = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Add Event in device's Calendar from React Native App</Text>
      <View style={styles.inputContainer}>
        ...
        <Text style={styles.text}>{moment.utc(TIME_NOW_IN_UTC).local().format('lll')}</Text>
      </View>
      <TouchableOpacity style={styles.button} onPress={addEventToCalendar}>
        <Text style={[styles.text, { color: 'white' }]}>Add this event to the calendar</Text>
      </TouchableOpacity>
    </View>
  );
};
